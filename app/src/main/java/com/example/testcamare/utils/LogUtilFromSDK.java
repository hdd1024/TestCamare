...
public class LogUtilFromSDK {
    //单例
    private static LogUtilFromSDK hbLogUtil;
    //打印调试开关
    ...
    //单例模式初始化
    public static LogUtilFromSDK getInstance() {
        if (hbLogUtil == null) {
            hbLogUtil = new LogUtilFromSDK();
        }
        return hbLogUtil;
    }

    /**
     * 设置是否打印日志，true为打印，false为不打印
     * @param isDebug
     */
